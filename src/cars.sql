...
select avg(year_of_issue) as "average year of issue"
from cars;
...
select sum(price) as "Sum of price Mercedes-Benz"
from cars
where brand ilike 'Mercedes-Benz';
...
select price as expensive_car, model
from cars
where price = (select max(price) from cars);

select price as cheep_car, model
from cars
...
select brand, year_of_issue
from cars
order by year_of_issue desc
offset 5 limit 10;

--17 Display cars where cars year of issue not between 1995 and 2005;
